...
import (
	...
	grpc "github.com/jmvargas/go-kit-example/catalog/pkg/grpc"
	pb "github.com/jmvargas/go-kit-example/catalog/pkg/grpc/pb"
	http "github.com/jmvargas/go-kit-example/catalog/pkg/http"
...
var fs = flag.NewFlagSet("catalog", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "catalog")
...
func initGRPCHandler(endpoints endpoint.Endpoints, g *group.Group) {
	...
	g.Add(func() error {
		...
		pb.RegisterCatalogServer(baseServer, grpcServer)
