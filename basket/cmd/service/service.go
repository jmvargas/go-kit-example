...
import (
	...
	http "github.com/jmvargas/go-kit-example/basket/pkg/http"
...
var fs = flag.NewFlagSet("basket", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "basket")
